...
print("\n\n------------------------------------------------------------------------------------"
      ...
      "Results will be calculated after tests are conducted, this can take a moment.\n"
      "------------------------------------------------------------------------------------")
...
def test_connections():
    ...
    # Testing API connection by checking response code (200 indicated response received).
